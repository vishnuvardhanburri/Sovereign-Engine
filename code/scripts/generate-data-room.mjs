...
copy('../docs/proof.md', 'docs/proof.md')
copy('../docs/TECHNICAL_PROOF_CHECKLIST.md', 'docs/TECHNICAL_PROOF_CHECKLIST.md')
copy('../docs/PRODUCTION_SUBMISSION_CHECKLIST.md', 'docs/PRODUCTION_SUBMISSION_CHECKLIST.md')
copy('../docs/acquisition/HOMEPAGE_COPY.md', 'docs/acquisition/HOMEPAGE_COPY.md')
copy('../docs/acquisition/ACQUIRE_LISTING_COPY.md', 'docs/acquisition/ACQUIRE_LISTING_COPY.md')
copy('../docs/acquisition/BUYER_REPLY_SYSTEM.md', 'docs/acquisition/BUYER_REPLY_SYSTEM.md')
copy('../docs/acquisition/FAQ.md', 'docs/acquisition/FAQ.md')
copy('../docs/acquisition/HUMAN_QA_CHECKLIST.md', 'docs/acquisition/HUMAN_QA_CHECKLIST.md')
copy('../docs/acquisition/BUYER_PROOF_GUARANTEE.md', 'docs/acquisition/BUYER_PROOF_GUARANTEE.md')
copy('../docs/acquisition/PRICE_STRATEGY.md', 'docs/acquisition/PRICE_STRATEGY.md')
copy('../docs/acquisition/QUEUE_SCALING_PROOF.md', 'docs/acquisition/QUEUE_SCALING_PROOF.md')
copy('../docs/OPERATING_GUIDE.md', 'docs/OPERATING_GUIDE.md')
